 ...
 */
@WebServlet(name = "ListaEventos", urlPatterns = {"/eventos"})
public class ListaEventos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher despachante = request.getRequestDispatcher("/eventos.jsp");
            request.setAttribute("eventos", eventos);//passando a lista para poder pegar no jsp
