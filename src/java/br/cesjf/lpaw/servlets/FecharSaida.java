 ...
 */
@WebServlet(name = "FecharSaida", urlPatterns = {"/FecharSaida"})
public class FecharSaida extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.fecharEstadia(estadia);
            
            //Cria evento
            Evento evento = new Evento();
            eventoDAO = new EventoDAO();
            evento.setAcao("Saída");
            ...
            throw new ServletException("FecharSaida.java!!!!!!!" + ex);
        }
