...
//            System.out.println(estadia.getId());
            request.setAttribute("estadia", estadia);//passando o objeto para poder pegar no jsp
            RequestDispatcher despachante = request.getRequestDispatcher("edicao.jsp");
